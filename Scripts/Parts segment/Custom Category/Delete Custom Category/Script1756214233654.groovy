...
WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/Custom Category/Delete Custom Category/Page_BDDemoPMT/input_Action_glowing-border'), 
    10)

WebUI.setText(findTestObject('Object Repository/Parts segment/Custom Category/Delete Custom Category/Page_BDDemoPMT/input_Action_glowing-border'), 
    'test')
...
WebUI.click(findTestObject('Object Repository/Parts segment/Custom Category/Delete Custom Category/Page_BDDemoPMT/button__swal2-confirm swal2-styled'))
