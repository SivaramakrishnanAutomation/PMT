...
WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/package/Delete Package/Page_BDDemoPMT/img'), 
    10)

WebUI.click(findTestObject('Object Repository/Parts segment/package/Delete Package/Page_BDDemoPMT/img'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/package/Delete Package/Page_BDDemoPMT/input_Action_glowing-border'), 
    10)
