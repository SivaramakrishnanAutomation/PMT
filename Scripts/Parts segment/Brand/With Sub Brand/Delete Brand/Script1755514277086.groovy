...
WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/Brand/With Sub Brand/Delete Brand/Page_BDDemoPMT/img'), 
    10)

WebUI.click(findTestObject('Object Repository/Parts segment/Brand/With Sub Brand/Delete Brand/Page_BDDemoPMT/img'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/Brand/With Sub Brand/Delete Brand/Page_BDDemoPMT/input_Delete_glowing-border'), 
    10)
