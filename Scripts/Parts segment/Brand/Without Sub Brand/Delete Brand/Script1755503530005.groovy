...
WebUI.waitForElementVisible(findTestObject('Parts segment/Brand/Without Sub Brand/Delete Brand/Page_BDDemoPMT/img'), 10)

WebUI.click(findTestObject('Parts segment/Brand/Without Sub Brand/Delete Brand/Page_BDDemoPMT/img'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/Brand/Without Sub Brand/Delete Brand/Page_BDDemoPMT/input_Delete_glowing-border'), 
    10)
