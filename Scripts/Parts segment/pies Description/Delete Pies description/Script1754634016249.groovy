...
WebUI.click(findTestObject('Object Repository/Parts segment/Pies Description/Delete pies Description/Page_BDDemoPMT/input_image'))

WebUI.click(findTestObject('Object Repository/Parts segment/Pies Description/Delete pies Description/Page_BDDemoPMT/button__swal2-confirm swal2-styled'))
