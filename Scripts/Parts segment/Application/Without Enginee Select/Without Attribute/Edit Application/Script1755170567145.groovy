...
WebUI.click(findTestObject('Object Repository/Parts segment/Application/Without Enginee Select/Without Attribute/Edit Application/Page_BDDemoPMT/input_Validate_appartsedit_btn'))

WebUI.setText(findTestObject('Object Repository/Parts segment/Application/Without Enginee Select/Without Attribute/Edit Application/Page_BDDemoPMT/textarea_ALL ENGINES_MainContent_GvApplicat_b57c46'), 
    'Automation All Enginee')

WebUI.click(findTestObject('Object Repository/Parts segment/Application/Without Enginee Select/Without Attribute/Edit Application/Page_BDDemoPMT/input_Show Non AcesAttributes_MainContent_b_6f1694'))
