...
WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/Interchange/Delete Interchange/Page_BDDemoPMT/img'), 
    10)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Parts segment/Interchange/Delete Interchange/Page_BDDemoPMT/input_No-Override_glowing-border'), 
    10)
