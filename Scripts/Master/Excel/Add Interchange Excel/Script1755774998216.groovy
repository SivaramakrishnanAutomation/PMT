...
//WebUI.click(findTestObject('Object Repository/Master/Excel/Add Parts Excel/Page_BDDemoPMT/a_Time 045734 AM_ucMenu_rptLevel1_lnkLink1_0'))
//WebUI.click(findTestObject('Object Repository/Master/Excel/Add Parts Excel/Page_BDDemoPMT/a_Data Import_ucMenu_rptLevel1_rptLevel2_0__663825'))
...
WebUI.selectOptionByLabel(findTestObject('Master/Excel/Add Parts Excel/Page_BDDemoPMT/select_Data Type_MainContent_ddldata'), 
    'Interchange', false)
...
WebUI.uploadFile(findTestObject('Master/Excel/Add Parts Excel/Page_BDDemoPMT/input_Upload my file_MainContent_FileUpload1'), 
    'C:\\Katalon Assets Files\\Excel Files\\Interchange.xlsm')

WebUI.click(findTestObject('Object Repository/Master/Excel/Add Parts Excel/Page_BDDemoPMT/input_Upload my file_MainContent_btnUpload'))
