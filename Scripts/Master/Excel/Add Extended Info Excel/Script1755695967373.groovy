...
//WebUI.click(findTestObject('Object Repository/Master/Excel/Add Extended Info Excel/Page_BDDemoPMT/a_Time 061957 AM_ucMenu_rptLevel1_lnkLink1_0'))
//WebUI.click(findTestObject('Object Repository/Master/Excel/Add Extended Info Excel/Page_BDDemoPMT/a_Data Import_ucMenu_rptLevel1_rptLevel2_0__663825'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Master/Excel/Add Extended Info Excel/Page_BDDemoPMT/select_Data Type_MainContent_ddldata'), 
    'tblExtendedProductInfo', true)
...
WebUI.uploadFile(findTestObject('Master/Excel/Add Digital Asset Excel/Page_BDDemoPMT/input_Upload my file_MainContent_FileUpload1'), 
    'C:\\Katalon Assets Files\\Excel Files\\Extended Info.xlsm')

WebUI.click(findTestObject('Object Repository/Master/Excel/Add Extended Info Excel/Page_BDDemoPMT/input_Upload my file_MainContent_btnUpload'))
